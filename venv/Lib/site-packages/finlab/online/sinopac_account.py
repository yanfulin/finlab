...
class SinopacAccount(Account):
  ...
  def create_order(self, action, stock_id, quantity, price=None, force=False, wait_for_best_price=False, order_cond=OrderCondition.CASH):
